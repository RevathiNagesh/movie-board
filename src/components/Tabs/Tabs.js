                    ...
                    <div className='container'>
                        <div id='tab-1-content' className={`tab-content-item ${activeTabName === CANCEL_AT_ANY_TIME && "show"}`}>
                            <div className='tab-1-content-inner'>
                                <div>
                                    <p className='text-lg'>
                                        If you decide Movie Time isn't for you - no<br /> problem. No
                                        commitment.<br /> Cancel online anytime
                                    </p>
                                    <Link to="/movie-show" className='btn btn-lg'>
                                        Watch Free For 30 days
                                    </Link>
                                    <img src="https://i.ibb.co/J2xDJV7/tab-content-1.png" className="i1" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div
                            ...
                            <div className='tab-2-content-bottom'>
                                ...
                                <div>
                                    ...
                                    <p className='text-dark'>Watch right on MovieTime.com.</p> </div>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className='container'>
                        <div
                            ...
                            <div className='text-center'>
                                <p className='text-lg'>
                                    Choose one plan and watch everything on MovieTime
                                </p>
                                <Link to="/movie-show" className='btn btn-lg'>
                                    Watch Free For 30 Days
                                </Link>
                            ...
                            <table className='table'>
                                ...
                                <tbody>
                                    <tr>
                                        <td>Monthly price after free month ends on 30/11/2023</td>
                                        <td>$6.99</td>
                                        <td>$12.99</td>
                                        <td>15.99</td>
                                    </tr>
